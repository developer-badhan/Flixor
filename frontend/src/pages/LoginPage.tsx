      ...
      >
        <div className="bg-black/75 p-10 sm:p-16 rounded-md shadow-2xl">
          ...
          <div className="mt-16 text-[#8c8c8c]">
            <p>New to Flixor? <Link to="/signup" className="text-white hover:underline">Sign up now.</Link></p>
            <p className="text-xs mt-4">
              This page is protected by Google reCAPTCHA to ensure you're not a bot. <Link to="/learn-more" className="text-blue-500 hover:underline">Learn more.</Link>
            </p>
          </div>
        </div>
      </motion.div>
